...
function Heading() {
  return (
    <div>
    <div className='w-screen grid text-center justify-items-center md:text-right md:flex lg:flex bg-white text-black py-2 px-[50px] md:items-center md:justify-between text-sm shadow-lg' id='heading'>
    ...
    <div className='w-full h-[8rem] bg-[#182144] text-white flex justify-center py-2 px-4'>
